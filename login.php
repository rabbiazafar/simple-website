...
<div class="container">
	<div class="row">
		<div class=" offset-3 col-md-6" id="login-form">
			<form> 
			<h2>Log In <i id="cross" class="fas fa-times"></i></h2>
				<label class="form-group">Email: <sub id="sup" >*</sub></label>
				 <div class="input-group"> <span class="input-group-addon"><i class="fas fa-pencil-alt"></i></span>
					 <input class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="Enter Email" required=""> 
				</div> 
				<br>
				...
				<div class="input-group"> <span class="input-group-addon"><i class="fas fa-eye"></i></span>
				 <input class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="Enter Password" required=""> 
				</div> 
				<br>
				<div class="row" id="login-span">
					<div class="col"><span><i class="far fa-arrow-alt-circle-right"><a style="color: white" href="#">Forgot Your Password?..</a></i> </span>
					<br>
					<span><i class="far fa-arrow-alt-circle-right"><a style="color: white" href="register.php">Create an Account</a></i> </span>
					</div>

					<div class="col"><div class="btn btn-success" id="Sign-In">Sign In</div></div>
				</div>
